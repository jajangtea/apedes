...
class Logic_Penanggalan extends Logic_Global {
     ...
     * nama bulan dalam bahasa indonesia
     */
    private $BulanM = array('none'=>' ',1=>'Januari', 2=>'Februari', 3=>'Maret', 4=>'April', 5=>'Mei',6=>'Juni', 7=>'Juli', 8=>'Agustus', 9=>'September');
    
    /*
     * nama bulan dalam bahasa indonesia
     */
    private $BulanP = array('none'=>' ', 10=>'Oktober', 11=>'November', 12=>'Desember');
     ...
     * digunakan untuk mendapatkan bulan
     */
    public function getBulanM($idx=null) {
        if ($idx === null) {
            return $this->BulanM;
        }else{
            return $this->BulanM[$idx];
        }
    }
     ...
     * digunakan untuk mendapatkan bulan
     */
    public function getBulanP($idx=null) {
        if ($idx === null) {
            return $this->BulanP;
        }else{
            return $this->BulanP[$idx];
        }
    }
    /**
